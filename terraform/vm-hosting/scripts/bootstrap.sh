...
<html lang="en">
  <head>
    ...
    <title>AKS Governance Host</title>
    <style>
  ...
  <body>
    <main>
      <h1>AKS Governance host is ready</h1>
      <p>Nginx, Docker, Node.js, Python, Certbot, and Azure CLI are installed. Deploy the frontend/backend services and configure virtual hosts for <code>governance.vaultrix.in</code> and <code>api.governance.vaultrix.in</code>.</p>
    </main>
  </body>
</html>
HTML
